...
if __name__ == "__main__":
    ...
    for seed in Seeds:
        ...
        for pred_len_raw in prediction_task:
            ...
            model = LSTM_Model(input_size=config.data_dim, hidden_size=config.d_model, num_layers=config.e_layers, forecast_window=pred_len, output_size=config.c_out, dropout=config.dropout)
