...
class DecoderLayer(nn.Module):
    ...
    '''
    def __init__(self, attn1, attn2, attn3, seg_len, d_model, n_heads, d_ff=None, dropout=0.1, out_seg_num = 10, factor = 10):
        super(DecoderLayer, self).__init__()
        self.self_attention = TwoStageAttentionLayer(attn1, attn2, out_seg_num, factor, d_model, n_heads, \
                                d_ff, dropout)    
