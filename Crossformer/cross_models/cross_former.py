...
from Crossformer.cross_models.cross_encoder import Encoder
from Crossformer.cross_models.cross_decoder import Decoder
from Crossformer.cross_models.attn import FullAttention, AttentionLayer, TwoStageAttentionLayer
from Crossformer.cross_models.cross_embed import *
...
class Crossformer(nn.Module):
    ...
    def forward(self, x_seq, encoder_input_mark, decoder_input ,decoder_input_mark):
        ...
        # print(x_seq.shape, encoder_input_mark.shape)
        x_seq = self.enc_value_embedding(x_seq, None)
        x_seq += self.enc_pos_embedding
        x_seq = self.pre_norm(x_seq)
        
        enc_out = self.encoder(x_seq)
        #print([t.shape for t in enc_out])
